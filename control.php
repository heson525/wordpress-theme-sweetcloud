<?php
$themename = "SweetClouds";    //主题名称
$shortname = "sweet";    //主题简写，必须是英文、数字、下划线组合
$options = array (
    array("name" => "相恋日期","id" => $shortname."_xianglian","std" => "20090530","type" => "text"),
	array("name" => "建站日期","id" => $shortname."_build","std" => "20100524","type" => "text")
